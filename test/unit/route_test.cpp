...
int main() {
    ...
    write_file(verifier_root + "/synsigra-0.17.0-py3-none-any.whl", "wheel");
    ...
    const syn_sig_ra::RouteResponse wheel =
        syn_sig_ra::route_request(
            "GET",
            "/syn_sig_ra/v1/downloads/verifier/synsigra-0.17.0-py3-none-any.whl",
            "/syn_sig_ra",
            "Bearer route-test-key",
            &store,
            download_pack_root
    ...
    std::remove((verifier_root + "/synsigra-0.17.0-py3-none-any.whl").c_str());
