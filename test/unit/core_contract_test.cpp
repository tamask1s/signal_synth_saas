...
int main() {
    ...
    require(
        !syn_sig_ra::parse_core_integration_contract(
            replaced(
                ...
                "\"contract\":\"synsigra_core_integration_v9\"",
                "\"contract\":\"synsigra_core_integration_v9\","
                "\"contract\":\"synsigra_core_integration_v9\""),
            parsed, error),
    ...
    tuple_mutations.push_back(std::make_pair(
        "synsigra_core_integration_v9", "synsigra_core_integration_v10"));
    tuple_mutations.push_back(std::make_pair(
    ...
    tuple_mutations.push_back(std::make_pair("synsigra_verification_protocol_v4", "synsigra_verification_protocol_v5"));
    ...
    tuple_mutations.push_back(std::make_pair("synsigra_local_verification_v4", "synsigra_local_verification_v5"));
    ...
    for (std::vector<std::pair<std::string, std::string> >::const_iterator it =
        ...
        require(
            !syn_sig_ra::parse_core_integration_contract(
                ...
                parsed, error),
            "every changed core tuple member must be rejected: " + it->first
        );
    }
    require(
        !syn_sig_ra::parse_core_integration_contract(
