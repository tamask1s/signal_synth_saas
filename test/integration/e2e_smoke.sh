...
if body.get("generator_git_commit") != "d7e55dd765517444e5a7831a7749adb458932370":
...
if not downloads.get("verifier_wheel_url", "").endswith(
        "/v1/downloads/verifier/synsigra-0.13.0-py3-none-any.whl"):
...
if "synsigra-verifier.zip" not in files or "synsigra-0.13.0-py3-none-any.whl" not in files:
