...
The browser UI supports selecting valid drafts, creating/deleting custom
packs, choosing them in the normal job form, polling the job, and downloading
the resulting manifest and ZIP.
